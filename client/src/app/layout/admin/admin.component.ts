...
export class AdminComponent implements OnInit {
  ...
  constructor(public menuItems: MenuItems, public router:Router, private userService: UserService) {
    this.navType = 'st2';
    ...
    this.changeUser(this.userService.getCurrentUser());
    this.userService.getLoggedInUser.subscribe(user => this.changeUser(user));
